	...
	<Dialog.Content class="max-h-[95vh] min-w-[62vw] overflow-auto">
		<Item.Root class="p-0">
			<Item.Content class="text-left">
				<Item.Title class="text-xl font-bold">Remove</Item.Title>
				<Item.Description>
					Use the following command to delete a file from your object storage bucket. Replace the
...
SIGNATURE=$(echo -en "DELETE\\n\\n\\n$TIMESTAMP\\n/${bucketName}/$KEY" \\
  ...
  | base64)
curl -X DELETE "http://${endpoint}/${bucketName}/$KEY" \\
  -H "Date: $TIMESTAMP" \\
