	...
	<Dialog.Content class="max-h-[95vh] min-w-[62vw] overflow-auto">
		<Item.Root class="p-0">
			<Item.Content class="text-left">
				...
				<Item.Description>
					Use the following command to upload a file to your object storage bucket. Replace the
...
SIGNATURE=$(echo -en "PUT\\n\\n$CONTENT_TYPE\\n$TIMESTAMP\\n/${bucketName}/$KEY" \\
  ...
  | base64)
curl -X PUT "http://${endpoint}/${bucketName}/$KEY" \\
