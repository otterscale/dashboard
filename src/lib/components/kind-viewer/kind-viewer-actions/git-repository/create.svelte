					...
					<Form
						schema={{
							...
							properties: {
								...
								ref: {
									...lodash.omit(
										lodash.get(jsonSchema, 'properties.spec.properties.ref') as Schema,
										'properties'
									),
									title: 'Reference',
									properties: {
										branch: {
											...(lodash.get(
												jsonSchema,
												'properties.spec.properties.ref.properties.branch'
											) as Schema),
											title: 'Branch'
										}
									}
								...
								interval: {
									...(lodash.get(jsonSchema, 'properties.spec.properties.interval') as Schema),
									title: 'Interval'
								},
								secretRef: {
									...lodash.omit(
									...
									properties: {
										name: {
											...(lodash.get(
												jsonSchema,
												'properties.spec.properties.secretRef.properties.name'
											) as Schema),
											title: 'Name'
										}
									}
						...
						uiSchema={{
							...
							url: {
								'ui:options': {
									shadcn4Text: {
										placeholder: 'https://github.com/stefanprodan/podinfo'
									}
								}
							}
						} as UiSchemaRoot}
